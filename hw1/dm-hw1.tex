...
\end{enumerate}
	...
	\configuratedText{Initially, the user chooses based on which library he wants to retrieve the data.
	
	The \textbf{HighLevelAPIClient} class, uses meteomatics.api library which is a connector created by meteomatics  to simplify the integration of the data into existing workflows. It is more easy to use and is supported in several programming languages.
	
	The \textbf{DirectAPIClient} class uses requests Python library in which we construct the API URL ourself. 
